...
- Snake tie-breaks use a deterministic fallback (current holder keeps it, else lowest player index) rather than manual selection — see follow-up task for adding manual tie-break UI.
...
- New round setup for course, date, stake, game types (any combination of Wolf/Snake/Dots/Nassau), and 2–6 players with handicaps
